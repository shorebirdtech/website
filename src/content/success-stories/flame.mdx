...
highlights:
  [
    ...
    'Powers [Idle Horizons](https://play.google.com/store/apps/details?id=com.pixelbuf.idlehorizons), [Danger World](https://danger.world/) among [other](https://github.com/flame-engine/awesome-flame).',
  ]
---
