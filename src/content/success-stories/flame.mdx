...
description:
  ...
  CI times by up to 95% with Shorebird CI.
date: 2025-10-07
cover: flame-cover.png
industry: Gaming
companySize: Open Source
website: 'https://flame-engine.org'
intro:
  Learn how Flame, an open source game engine built for Flutter, reduced their
  CI times by up to 95% with Shorebird CI.
seoTitle: Flame - Shorebird Success Story
seoDescription: Shorebird CI reduced check times by up to 95% for Flame.
highlights:
  [
    'Powers [Idle
    Horizons](https://play.google.com/store/apps/details?id=com.pixelbuf.idlehorizons),
    [Danger World](https://danger.world/) and
    [others](https://github.com/flame-engine/awesome-flame).',
    'Open source project with over 10,000 GitHub stars',
    'Monorepo containing over 29 packages',
    'Shorebird CI reduced check times by up to 95%',
  ]
---
...
[10,000 stars on GitHub](https://github.com/flame-engine/flame) and is a vital,
...
to worry about maintaining the workflows, versions of dependencies, and other
typical CI details.
...
time taken to perform CI checks. Before Shorebird, the previous CI checks would
